    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', django_extensions.db.fields.AutoSlugField(blank=True, editable=False, help_text='Unique identifier of menu. Will be populated automatically from name of menu. Change only if needed.', populate_from='name')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_of_submenu', models.CharField(blank=True, help_text='Name of submenu (LEAVE BLANK if there is no custom submenu)', max_length=50, null=True)),
                ...
                ('menu', modelcluster.fields.ParentalKey(help_text='Name of the menu to which this item belongs', on_delete=django.db.models.deletion.CASCADE, related_name='menu_items', to='cms.Menu')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
